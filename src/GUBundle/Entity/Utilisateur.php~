 ...
 */
class Utilisateur extends BaseUser implements NotifiableInterface
{
    /**
     * @ORM\Id
    ...
    protected $cv;
    /**
     * @ORM\OneToMany(targetEntity="ForumBundle\Entity\AimeF", mappedBy="id_user",orphanRemoval=true,fetch="EAGER")
     */
